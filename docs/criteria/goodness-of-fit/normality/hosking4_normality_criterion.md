# Hosking4 test for normality

## Description
Performs the Hosking4 goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on third-level trimmed L-moment ratios for skewness and kurtosis.
...
test_statistic = Hosking4NormalityGofStatistic()
...
## Details
The implementation evaluates the Hosking4 statistic for the supplied observations. Large or small values should be interpreted according to the statistic alternative used by the class implementation.
