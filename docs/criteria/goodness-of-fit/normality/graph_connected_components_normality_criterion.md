...
## Description
Performs the Graph connected components goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on the number of connected components in a proximity graph built from the sample.
...
test_statistic = GraphConnectedComponentsNormalityGofStatistic()
...
## Details
The implementation evaluates the Graph connected components statistic for the supplied observations. Large or small values should be interpreted according to the statistic alternative used by the class implementation.
