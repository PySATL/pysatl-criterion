...
## Description
Performs the Graph edges number goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on the number of edges in a proximity graph built from the sample.
...
test_statistic = GraphEdgesNumberNormalityGofStatistic()
...
## Details
The implementation evaluates the Graph edges number statistic for the supplied observations. Large or small values should be interpreted according to the statistic alternative used by the class implementation.
