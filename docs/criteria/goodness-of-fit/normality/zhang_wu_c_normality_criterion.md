...
## Description
Performs the Zhang-Wu C goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on log-ratio transformations of fitted normal distribution values.
