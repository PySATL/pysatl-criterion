...
## Description
Performs the Graph average degree goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on the average degree in a proximity graph built from the sample.
