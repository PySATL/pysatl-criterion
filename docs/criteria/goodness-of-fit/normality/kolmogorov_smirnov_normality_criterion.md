...
## Description
Performs the Kolmogorov-Smirnov goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on empirical distribution function with the standard normal cumulative distribution function.
...
## Details
The implementation evaluates the Kolmogorov-Smirnov statistic for the supplied observations. Large or small values should be interpreted according to the statistic alternative used by the class implementation.
