...
## Description
Performs the Graph clique number goodness-of-fit test for the hypothesis of normality.
...
Test Statistic
The statistic is based on the maximum clique size in a proximity graph built from the sample.
...
test_statistic = GraphCliqueNumberNormalityGofStatistic()
...
## Details
The implementation evaluates the Graph clique number statistic for the supplied observations. Large or small values should be interpreted according to the statistic alternative used by the class implementation.
