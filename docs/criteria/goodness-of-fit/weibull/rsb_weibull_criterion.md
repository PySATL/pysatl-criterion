# RSB test for Weibull distribution

## Description
Performs RSB goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a Smith-Bain probability plot correlation statistic.
...
test_statistic = RSBWeibullGofStatistic(a=1, k=2)
