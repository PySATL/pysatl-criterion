# Stabilized probability plot test for Weibull distribution

## Description
Performs Stabilized probability plot goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on the maximum discrepancy between stabilized plotting positions and transformed fitted values.
