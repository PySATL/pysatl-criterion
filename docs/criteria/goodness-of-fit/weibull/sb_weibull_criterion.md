# Sb test for Weibull distribution

## Description
Performs Sb goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a Shapiro-Wilk type statistic computed from log-transformed observations.
...
test_statistic = SbWeibullGofStatistic(a=1, k=2)
