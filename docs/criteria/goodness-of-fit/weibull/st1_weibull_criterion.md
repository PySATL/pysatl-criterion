# ST1 test for Weibull distribution

## Description
Performs ST1 goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a smooth-test statistic based on skewness of transformed observations.
