# Ozturk-Korukoglu test for Weibull distribution

## Description
Performs Ozturk-Korukoglu goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a Weibull probability plot statistic using weighted log-order terms.
