# Tiku-Singh test for Weibull distribution

## Description
Performs Tiku-Singh goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on normalized spacings of log-transformed observations.
...
test_statistic = TikuSinghWeibullGofStatistic(a=1, k=2)
