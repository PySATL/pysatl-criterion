# SB WPP test for Weibull distribution

## Description
Performs SB WPP goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a Weibull probability plot Shapiro-Wilk type statistic.
