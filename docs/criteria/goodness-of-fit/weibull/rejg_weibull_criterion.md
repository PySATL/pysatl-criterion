# Evans-Johnson-Green test for Weibull distribution

## Description
Performs Evans-Johnson-Green goodness-of-fit test for the hypothesis that the sample comes from a Weibull distribution.
...
Test Statistic
The statistic is based on a probability plot correlation statistic using maximum-likelihood Weibull shape estimation.
...
test_statistic = REJGWeibullGofStatistic(a=1, k=2)
