# KL integral test for log-normal distribution

## Description
Performs KL integral goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the integral of squared standardized Kullback-Leibler divergence components.
...
test_statistic = KLIntegralLogNormalGoFStatistic(s=1, scale=1)
