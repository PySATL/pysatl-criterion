# D'Agostino test for log-normal distribution

## Description
Performs D'Agostino goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped DAgostino normality statistic applied to standardized log observations.
...
test_statistic = DagostinoLogNormalGofStatistic(s=1, scale=1)
