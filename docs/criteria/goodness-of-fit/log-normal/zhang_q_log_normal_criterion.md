# Zhang Q test for log-normal distribution

## Description
Performs Zhang Q goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Zhang Q normality statistic applied to standardized log observations.
...
test_statistic = ZhangQLogNormalGofStatistic(s=1, scale=1)
