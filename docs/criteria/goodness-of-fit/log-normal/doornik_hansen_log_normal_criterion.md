# Doornik-Hansen test for log-normal distribution

## Description
Performs Doornik-Hansen goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Doornik-Hansen normality statistic applied to standardized log observations.
...
test_statistic = DoornikHansenLogNormalGofStatistic(s=1, scale=1)
