# Chen-Shapiro test for log-normal distribution

## Description
Performs Chen-Shapiro goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Chen-Shapiro normality statistic applied to standardized log observations.
...
test_statistic = ChenShapiroLogNormalGofStatistic(s=1, scale=1)
