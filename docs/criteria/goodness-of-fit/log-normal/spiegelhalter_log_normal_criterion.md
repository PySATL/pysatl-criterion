# Spiegelhalter test for log-normal distribution

## Description
Performs Spiegelhalter goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Spiegelhalter normality statistic applied to standardized log observations.
...
test_statistic = SpiegelhalterLogNormalGofStatistic(s=1, scale=1)
