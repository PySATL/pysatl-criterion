# SWRG test for log-normal distribution

## Description
Performs SWRG goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped SWRG normality statistic applied to standardized log observations.
...
test_statistic = SWRGLogNormalGofStatistic(s=1, scale=1)
