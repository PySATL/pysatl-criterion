# Robust Jarque-Bera test for log-normal distribution

## Description
Performs Robust Jarque-Bera goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped robust Jarque-Bera normality statistic applied to standardized log observations.
...
test_statistic = RobustJarqueBeraLogNormalGofStatistic(s=1, scale=1)
