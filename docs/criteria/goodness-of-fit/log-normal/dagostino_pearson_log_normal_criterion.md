# D'Agostino-Pearson test for log-normal distribution

## Description
Performs D'Agostino-Pearson goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped combined skewness-kurtosis normality statistic applied to standardized log observations.
...
test_statistic = DAPLogNormalGofStatistic(s=1, scale=1)
