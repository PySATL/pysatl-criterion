# Jarque-Bera test for log-normal distribution

## Description
Performs Jarque-Bera goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Jarque-Bera normality statistic applied to standardized log observations.
...
test_statistic = JBLogNormalGofStatistic(s=1, scale=1)
