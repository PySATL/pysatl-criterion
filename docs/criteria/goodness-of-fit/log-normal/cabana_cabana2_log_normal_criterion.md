# Cabana-Cabana2 test for log-normal distribution

## Description
Performs Cabana-Cabana2 goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Cabana-Cabana2 normality statistic applied to standardized log observations.
