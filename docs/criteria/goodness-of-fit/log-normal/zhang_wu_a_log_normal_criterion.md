# Zhang-Wu A test for log-normal distribution

## Description
Performs Zhang-Wu A goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Zhang-Wu A normality statistic applied to standardized log observations.
...
test_statistic = ZhangWuALogNormalGofStatistic(s=1, scale=1)
