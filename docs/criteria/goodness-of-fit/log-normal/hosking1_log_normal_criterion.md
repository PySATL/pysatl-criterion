# Hosking1 test for log-normal distribution

## Description
Performs Hosking1 goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Hosking1 normality statistic applied to standardized log observations.
...
test_statistic = Hosking1LogNormalGofStatistic(s=1, scale=1)
