# Shapiro-Wilk test for log-normal distribution

## Description
Performs Shapiro-Wilk goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Shapiro-Wilk normality statistic applied to standardized log observations.
...
test_statistic = ShapiroWilkLogNormalGofStatistic(s=1, scale=1)
