# Martinez-Iglewicz test for log-normal distribution

## Description
Performs Martinez-Iglewicz goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Martinez-Iglewicz normality statistic applied to standardized log observations.
...
test_statistic = MartinezIglewiczLogNormalGofStatistic(s=1, scale=1)
