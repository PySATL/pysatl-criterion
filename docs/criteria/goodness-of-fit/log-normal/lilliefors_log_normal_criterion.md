# Lilliefors test for log-normal distribution

## Description
Performs Lilliefors goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Lilliefors normality statistic applied to standardized log observations.
...
test_statistic = LillieforsLogNormalGofStatistic(s=1, scale=1)
