...
## Description
Performs Cramer-von Mises goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on squared differences between log-normal CDF values and expected plotting positions.
...
test_statistic = CramerVonMiseLogNormalGofStatistic(s=1, scale=1)
