# Cabana-Cabana1 test for log-normal distribution

## Description
Performs Cabana-Cabana1 goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Cabana-Cabana1 normality statistic applied to standardized log observations.
...
test_statistic = CabanaCabana1LogNormalGofStatistic(s=1, scale=1)
