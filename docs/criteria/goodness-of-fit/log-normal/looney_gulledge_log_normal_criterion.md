# Looney-Gulledge test for log-normal distribution

## Description
Performs Looney-Gulledge goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Looney-Gulledge normality statistic applied to standardized log observations.
...
test_statistic = LooneyGulledgeLogNormalGofStatistic(s=1, scale=1)
