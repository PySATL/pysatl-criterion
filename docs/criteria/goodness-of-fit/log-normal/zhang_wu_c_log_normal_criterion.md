# Zhang-Wu C test for log-normal distribution

## Description
Performs Zhang-Wu C goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Zhang-Wu C normality statistic applied to standardized log observations.
...
test_statistic = ZhangWuCLogNormalGofStatistic(s=1, scale=1)
