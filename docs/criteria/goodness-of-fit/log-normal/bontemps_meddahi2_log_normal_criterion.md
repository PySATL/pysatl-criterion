# Bontemps-Meddahi2 test for log-normal distribution

## Description
Performs Bontemps-Meddahi2 goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Bontemps-Meddahi2 normality statistic applied to standardized log observations.
...
test_statistic = BontempsMeddahi2LogNormalGofStatistic(s=1, scale=1)
