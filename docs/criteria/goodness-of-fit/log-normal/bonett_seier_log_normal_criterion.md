# Bonett-Seier test for log-normal distribution

## Description
Performs Bonett-Seier goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Bonett-Seier normality statistic applied to standardized log observations.
...
test_statistic = BonettSeierLogNormalGofStatistic(s=1, scale=1)
