# GMG test for log-normal distribution

## Description
Performs GMG goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped GMG normality statistic applied to standardized log observations.
...
test_statistic = GMGLogNormalGofStatistic(s=1, scale=1)
