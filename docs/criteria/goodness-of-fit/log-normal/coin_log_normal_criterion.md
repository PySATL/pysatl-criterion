# Coin test for log-normal distribution

## Description
Performs Coin goodness-of-fit test for the hypothesis that the sample comes from a log-normal distribution.
...
Test Statistic
The statistic is based on the wrapped Coin normality statistic applied to standardized log observations.
...
test_statistic = CoinLogNormalGofStatistic(s=1, scale=1)
